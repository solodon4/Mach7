...
that the programmer knew the cost). 

A lot has been said about pros and cons of visitor design pattern~\cite{DesignPatterns1993,Zenger:2001}. 
...
The former was consistently slower than the latter in our experience, even 
though the opposite was noted on some architectures for small number of 
cases~\cite[\textsection 4]{garrigue-98}.
