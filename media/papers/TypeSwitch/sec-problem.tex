...
subtyping polymorphism, such a broad definition subsumes numerous different type 
...
C++ handled the general dynamic casting since 1987 when the multiple inheritance 
