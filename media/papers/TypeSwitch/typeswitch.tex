...
compilers and tool chains, we implement our type switch constructs as an ISO C++11 library.
...
extensibility restrictions typical of the visitor design pattern. 
...
J\"arvi for assistance in comparison to other languages, Andrew Sutton, Peter 
Pirkelbauer and Abe Skolnik for helpful discussions and comments to numerous 
rewrites of this paper. We also benefitted greatly from insightful comments by 
anonymous reviewers on earlier revisions of this work. We would also like to 
thank Karel Driesen for letting us use his class hierarchies benchmark for this 
work.
