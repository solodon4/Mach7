...
compilers and tool chains, we implement our type switch construct as an ISO \Cpp{}11 
...
in object-oriented programming. It also comes close to equivalent code in 
functional languages, such as OCaml and Haskell, while allowing for extensibility 
of types. The type-switching code is easier to use and is more expressive  
