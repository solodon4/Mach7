...
\preprintfooter{Y.Solodkyy, G.Dos Reis, B.Stroustrup: Efficient Type Switch for C++}   % 'preprint' option specified.

\title{Efficient Type Switch for C++}
...
dispatch, multi-methods and other facilities that depend on then run-time type 
