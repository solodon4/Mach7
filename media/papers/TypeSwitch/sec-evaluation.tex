...
or \emph{specialized} syntax. Each syntax was used to run tests on polymorphic 
encoding (\emph{Open}) and tagged encoding (\emph{Tag}). Specialized syntax  
avoids generating unnecessary syntactic structure used to unify syntax, and thus 
produces faster code. We include it in our results as a compiler implementation 
of type switching will be able to distinguish each case and thus generate only 
