...
experiments had $H_{kl}^V$ with 2 conflicts, 0.87\% with 3 etc. These numbers do 
not indicate that the hash function we used is better than other hash functions, 
they do indicate instead that the set of vtbl-pointers present in many 
applications is particularly suitable for such a hash function.
