...
compare the ease of use, readibility and maintainability of each approach, as 
...
chosen. We prefered median to average to diminish the influence of other 
...
\hline % ---------------------------------------------------------------
 &     & \multicolumn{2}{@{}c@{}|}{G++} & \multicolumn{4}{@{}c@{}||}{MS Visual C++} 
       & \multicolumn{2}{@{}c@{}|}{G++} & \multicolumn{4}{@{}c@{}}{MS Visual C++} \\
\hline % ---------------------------------------------------------------
...
unfortunately, Visual C++ does not provide any similar facilities. Instead, 
Microsoft suggests to use \emph{Profile-Guided Optimizations} (PGO) to achieve 
the same, which is why we list the results for Visual C++ both with and without 
...
efficient caching container that avoids the table altogether, thus significanly 
...
compiler limitations. Both GCC and Visual C++, for example, could not generate 
