...
\scriptsize
%\footnotesize
% Meaning of letters in variable name:
% g - GCC
% v - Visual C++
% V - Visual C++ with PGO
% l - Linux machine test (Sierra)
% w - Windows machine test x86 (my laptop)
% x - Windows machine test x64 (my laptop)
...
support provided by \emph{Mach7} was invaluable in finding out all such cases.
