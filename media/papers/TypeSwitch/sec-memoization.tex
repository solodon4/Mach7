...
of them to discover the types in between). %A visitor design pattern could 
...
within the most-derived object of type $C$. Ommitting the immutable context $\mathfrak{P}$: 
