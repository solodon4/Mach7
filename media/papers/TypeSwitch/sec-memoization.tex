...
\emph{inheritance} relation on types of program $P$.
...
when understood from the context. In the example from Figure~\ref{fig:objlayout}(2), 
an object of the most-derived class \code{D} has the following 
$\mathsf{Repeated}$ subobjects:
\code{D::C::Y}, 
\code{D::B::A::Z}, 
\code{D::C::A::Z}, 
\code{D::B::A}, 
...
\code{D::C}, 
\code{D}.
Similarly, in the example from Figure~\ref{fig:objlayout}(3), an object of the 
most-derived class \code{D} has the following $\mathsf{Repeated}$ subobjects:  
\code{D::C::Y}, 
\code{D::B}, 
\code{D::C}, 
\code{D}
