...
(included in its subobjects) but only one such pointer points to the 
dynamic type of the complete type.  We assume that a C++ compiler provides
access to that vtable pointer (or at least document the position of that
