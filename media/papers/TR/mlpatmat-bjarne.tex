...
for which \ys{compile-time polymorphism can be used}. The
...
visitors unsuitable to express our application logic, \ys{and slow}. 
...
For pattern matching we chose optimized O'Caml as our standard for closed \ys{(compile-time
